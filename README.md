...
pipx install copier
pipx install 'weisssrv-lib-cli[cluster] @ git+https://git.ericsweiss.com/eric/weisssrv-lib.git@v0.5.1#subdirectory=cli'
...
| `lib_url` / `lib_ref` | upstream URL / `v0.5.1` | weisssrv-lib source and pin for collection, CI includes, TF modules |
